...
vim.keymap.set('n', '<leader>bc', close_all_buffers_except_current, { desc = 'Close all buffers except current' })
vim.keymap.set('n', '<leader>bC', close_all_buffers, { desc = 'Close all buffers' })
...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      -- TODO: Change [S]earch to [F]ind & change nvim_tree (<leader>f) keybind
      require('which-key').register {
        ...
        ['<leader>p'] = { name = '[P]ackage management', _ = 'which_key_ignore' },
      }
    end,
  },
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      --     local filter_this = { 'tsserver', 'angularls' }
      --     for i = 1, #filter_this do
      --       if filter_this[i] == client.name then
      --         return true
      --       end
      --     end
      --     return false
  ...
  { -- Autoformat
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>lf', require('conform').format, { desc = '[F]ormat document' })
    end,
  },
